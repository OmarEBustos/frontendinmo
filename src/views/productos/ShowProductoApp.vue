<template>
    <div class="pb-5">
        <section class="product-details" style="margin-top: 5rem !important;">
      <div class="container">
        <div class="row">
          <div class="col-lg-7 pt-4 order-2 order-lg-1">
            <div class="row">   
              <div class="d-none d-md-block col-md-2 pe-0"><br><br><br><br>
              ...
              <div class="col-12 col-md-10 detail-carousel"><br><br><br><br>
               <!-- <div class="ribbon ribbon-info">Fresh</div>
                <div class="ribbon ribbon-primary">Sale</div>    imagen grande-->
          ...
          <div class="col-lg-5 ps-lg-4 order-1 order-lg-2"><br>
            <ul class="breadcrumb undefined">
              <li class="breadcrumb-item"><router-link to="/">Inicio</router-link></li>
              <li class="breadcrumb-item"><router-link to="/shop">Tienda</router-link></li>
              <li class="breadcrumb-item">
                <router-link :to="{name: 'shop',query: {categoria:producto.categoria}}" style="text-decoration: none; color:black">
                  {{ producto.categoria }}</router-link></li>
            </ul>
   ...
   <!-- <section class="mt-5">
    ...
    </section>product-hover-overlay-link
    ...
    <section class="my-5">
      <div class="container">
        ...
        <div class="row" >
          ...
          <div class="col-lg-3 col-md-4 col-9" v-for="item in productos_relaciones">
            <router-link :to="{name: 'show-producto',params:{slug: item.slug}}" style="text-decoration: none; color:black">
              <div class="product">
                <div class="product-image">
                  
                  <img class="img-fluid" :src="$url+'/obtener_portada_producto/'+item.portada" alt="productos"/>
                  
                </div>
                <div class="py-2"><br><br>
                  <b class="">{{item.categoria}}</b>
